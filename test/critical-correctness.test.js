...
async function run() {
...

  {
    ...
    assert.strictEqual(applianceDetailSlotsComplete(caller), false);

    harvestApplianceDetailSlots(caller, "I don't know");
    ...
    assert.strictEqual(applianceDetailSlotsComplete(caller), true);
  }
